...
<section id="examples" class="text-center" style="margin-top:-20px">
        ...
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-8 text-right">
                    <u><i>
                            <h3 class="product_name text-left">Sản Phẩm Khuyến Mãi</h3>
                        </i></u>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="row">
                <select class="form-control" id="mySelect"
                    ...
                    <option value="index.php?action=sanpham&act=sanphamkhuyenmai">Tất cả</option>
                    <option value="index.php?action=sanpham&act=sanphamkhuyenmai1">Đơn giá tăng dần</option>
                    <option value="index.php?action=sanpham&act=sanphamkhuyenmai2">Đơn giá giảm dần</option>
                    <option value="index.php?action=sanpham&act=sanphamkhuyenmai3">Sắp xếp A - Z</option>
                </select>
            </div>
        </div>
    </div>
    ...
    if (isset($_GET['action'])) {
        if (isset($_GET['act']) && $_GET['act'] == 'sanphamkhuyenmai') {
            $ac = 1;
        } elseif (isset($_GET['act']) && $_GET['act'] == 'sanphamkhuyenmai1') {
            $ac = 2;
        } elseif (isset($_GET['act']) && $_GET['act'] == 'sanphamkhuyenmai2') {
            $ac = 3;
        } elseif (isset($_GET['act']) && $_GET['act'] == 'sanphamkhuyenmai3') {
            $ac = 4;
        }
    }
    ?>
    ...
    <div class="row">
        ...
        if ($ac == 1) {
            $hh = new hanghoa();
            $result = $hh->getAllSale($start, $limit);
        }
        if ($ac == 2) {
            $gg = new locsanpham();
            $result = $gg->getSaleU($start, $limit);// phân trang
        }
        if ($ac == 3) {
            $gg = new locsanpham();
            $result = $gg->getSaleD($start, $limit);// phân trang
        }
        if ($ac == 4) {
            $gg = new locsanpham();
            $result = $gg->getSaleAZ($start, $limit);// phân trang
        }
...
<nav aria-label="Page navigation">
    <ul class="pagination justify-content-center">
        ...
        if ($current_page > 1 && $page > 1) {
            if ($ac == 1) {
                echo '<li>
                    <a href="index.php?action=sanpham&act=sanphamkhuyenmai&page=' . ($current_page - 1) . '" class="page-link">Trước</a>
                    </li>';
            }
            if ($ac == 2) {
                echo '<li>
                    <a href="index.php?action=sanpham&act=sanphamkhuyenmai1&page=' . ($current_page - 1) . '" class="page-link">Trước</a>
                    </li>';
            }
            if ($ac == 3) {
                echo '<li>
                    <a href="index.php?action=sanpham&act=sanphamkhuyenmai2&page=' . ($current_page - 1) . '" class="page-link">Trước</a>
                    </li>';
            }
            if ($ac == 4) {
                echo '<li>
                    <a href="index.php?action=sanpham&act=sanphamkhuyenmai3&page=' . ($current_page - 1) . '" class="page-link">Trước</a>
                    </li>';
            }
        ...
        for ($i = 1; $i <= $page; $i++) {
            ...
            if ($ac == 2) { ?>
                <li class="page-item <?php echo ($i == $current_page) ? 'active' : ''; ?>">
                    <a href="index.php?action=sanpham&act=sanphamkhuyenmai1&page=<?php echo $i; ?>"
                        class="page-link"><?php echo $i; ?></a>
                </li>
            <?php }
            if ($ac == 3) { ?>
                <li class="page-item <?php echo ($i == $current_page) ? 'active' : ''; ?>">
                    <a href="index.php?action=sanpham&act=sanphamkhuyenmai2&page=<?php echo $i; ?>"
                        class="page-link"><?php echo $i; ?></a>
                </li>
            <?php }
            if ($ac == 4) { ?>
                <li class="page-item <?php echo ($i == $current_page) ? 'active' : ''; ?>">
                    <a href="index.php?action=sanpham&act=sanphamkhuyenmai3&page=<?php echo $i; ?>"
                        class="page-link"><?php echo $i; ?></a>
                </li>
                <?php
            }
        ...
        if ($current_page < $page && $page > 1) {
            if ($ac == 1) {
                echo '<li>
                    <a href="index.php?action=sanpham&act=sanphamkhuyenmai&page=' . ($current_page + 1) . '" class="page-link">Sau</a>
                    </li>';
            }
            if ($ac == 2) {
                echo '<li>
                    <a href="index.php?action=sanpham&act=sanphamkhuyenmai1&page=' . ($current_page + 1) . '" class="page-link">Sau</a>
                    </li>';
            }
            if ($ac == 3) {
                echo '<li>
                    <a href="index.php?action=sanpham&act=sanphamkhuyenmai2&page=' . ($current_page + 1) . '" class="page-link">Sau</a>
                    </li>';
            }
            if ($ac == 4) {
                echo '<li>
                    <a href="index.php?action=sanpham&act=sanphamkhuyenmai3&page=' . ($current_page + 1) . '" class="page-link">Sau</a>
                    </li>';
            }
        }
        ?>
